...
%epp T_LNUMBER "<lnumber>"
%epp T_DNUMBER "<dnumber>"
%epp T_STRING  "<name>"
%epp T_VARIABLE "$<var>"
%epp T_CONSTANT_ENCAPSED_STRING '"<string>"'

%epp T_INCLUDE "include"
%epp T_INCLUDE_ONCE "include_once"
%epp T_EVAL "eval"
%epp T_REQUIRE "require"
%epp T_REQUIRE_ONCE "require_once"
%epp T_LOGICAL_OR "or"
%epp T_LOGICAL_XOR "xor"
%epp T_LOGICAL_AND "and"
%epp T_PRINT "print"
%epp T_YIELD "yield"
%epp T_YIELD_FROM "yield from"
%epp T_PLUS_EQUAL "+="
%epp T_MINUS_EQUAL "-="
%epp T_MUL_EQUAL "*="
%epp T_DIV_EQUAL "/="
...
%epp T_IS_NOT_EQUAL "!="
%epp T_IS_IDENTICAL "==="
%epp T_IS_NOT_IDENTICAL "!=="
%epp T_IS_SMALLER_OR_EQUAL "<="
%epp T_IS_GREATER_OR_EQUAL ">="
%epp T_SPACESHIP "<=>"
%epp T_SL "<<"
%epp T_SR ">>"
%epp T_INSTANCEOF "instanceof"
%epp T_INC "++"
%epp T_DEC "--"
%epp T_INT_CAST "(int)"
%epp T_DOUBLE_CAST "(double)"
%epp T_STRING_CAST "(string)"
%epp T_ARRAY_CAST "(array)"
%epp T_OBJECT_CAST "(object)"
%epp T_BOOL_CAST "(bool)"
%epp T_UNSET_CAST "(unset)"
%epp T_NEW "new"
%epp T_CLONE "clone"
%epp T_EXIT "exit"
%epp T_IF "if"
...
%epp T_DO "do"
%epp T_WHILE "while"
%epp T_ENDWHILE "endwhile"
%epp T_FOR "for"
%epp T_ENDFOR "endfor"
%epp T_FOREACH "foreach"
%epp T_ENDFOREACH "endforeach"
%epp T_DECLARE "declare"
%epp T_ENDDECLARE "enddeclare"
%epp T_AS "as"
%epp T_SWITCH "switch"
%epp T_ENDSWITCH "endswitch"
%epp T_CASE "case"
%epp T_DEFAULT "default"
%epp T_BREAK "break"
%epp T_CONTINUE "continue"
%epp T_GOTO "goto"
%epp T_FUNCTION "function"
%epp T_CONST "const"
%epp T_RETURN "return"
%epp T_TRY "tru"
%epp T_CATCH "catch"
%epp T_FINALLY "finally"
%epp T_THROW "throw"
%epp T_USE "use"
%epp T_INSTEADOF "insteadof"
%epp T_GLOBAL "global"
%epp T_STATIC "static"
%epp T_ABSTRACT "abstract"
%epp T_FINAL "final"
%epp T_PRIVATE "private"
%epp T_PROTECTED "protected"
%epp T_PUBLIC "public"
%epp T_VAR "var"
%epp T_UNSET "unset"
%epp T_ISSET "isset"
%epp T_EMPTY "empty"
%epp T_HALT_COMPILER "__halt_compiler"
%epp T_CLASS "class"
%epp T_TRAIT "trait"
%epp T_INTERFACE "interface"
%epp T_EXTENDS "extends"
%epp T_IMPLEMENTS "implements"
%epp T_OBJECT_OPERATOR "->"
%epp T_DOUBLE_ARROW "=>"
%epp T_LIST "list"
%epp T_ARRAY "array"
%epp T_CALLABLE "callable"
%epp T_LINE "__LINE__"
%epp T_FILE "__FILE__"
%epp T_DIR "__DIR__"
%epp T_CLASS_C "__CLASS__"
%epp T_TRAIT_C "__TRAIT__"
%epp T_METHOD_C "__METHOD__"
%epp T_FUNC_C "__FUNCTION__"
%epp T_DOLLAR_OPEN_CURLY_BRACES "${"
%epp T_CURLY_OPEN "{$"
%epp T_PAAMAYIM_NEKUDOTAYIM "::"
%epp T_NAMESPACE "namespace"
%epp T_NS_C "__NAMESPACE__"
%epp T_NS_SEPARATOR "\\"
%epp T_ELLIPSIS "..."
%epp T_COALESCE "??"
%epp T_POW "**"
